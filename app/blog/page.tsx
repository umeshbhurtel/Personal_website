      ...
      >
        <div className="container-max flex items-center justify-between h-16">
          <Link
            ...
            style={{ color: 'var(--text-muted)', fontFamily: 'var(--font-body)', textDecoration: 'none' }}
          >
            <ArrowLeft size={15} />
            Back home
          </Link>
      ...
      <main className="pt-32 pb-24 min-h-screen" style={{ background: 'var(--bg-primary)' }}>
        <div className="container-max">
          <div className="mb-14">
            ...
            <h1
              className="mt-4 mb-4"
              style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(2.2rem, 5vw, 4rem)' }}
            >
              All <em style={{ color: 'var(--accent)' }}>Writing</em>
            </h1>
            <p style={{ color: 'var(--text-secondary)', maxWidth: '520px', lineHeight: 1.75 }}>
              Technology, research methodology, global work trends, and what I&apos;m learning — no
              noise. Just insight.
            </p>
          </div>
                ...
                <Link key={post.slug} href={`/blog/${post.slug}`} style={{ textDecoration: 'none' }}>
                  <article className="blog-card p-6 h-full flex flex-col cursor-pointer">
                    ...
                    <h2
                      ...
                      style={{ fontFamily: 'var(--font-heading)', fontSize: '1.25rem', color: 'var(--text-primary)', lineHeight: 1.35 }}
                    >
                      {post.title}
                    </h2>
