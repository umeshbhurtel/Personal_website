    ...
    <>
      ...
      <main className="pt-28 pb-24 min-h-screen" style={{ background: 'var(--bg-primary)' }}>
        <div className="container-max" style={{ maxWidth: '860px' }}>
          ...
          <h1 className="mb-4" style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', color: 'var(--text-primary)', lineHeight: 1.2 }}>
            {cs.title}
          </h1>

          {cs.description && (
            <p className="mb-8" style={{ color: 'var(--text-secondary)', lineHeight: 1.8, maxWidth: '620px', fontSize: '1.05rem' }}>
              {cs.description}
            </p>
          )}
          ...
          {cs.pdfPath && (
            <div className="mb-10 flex flex-wrap gap-3">
              ...
              <a
                ...
                style={{ background: 'var(--bg-glass)', border: '1px solid var(--border)', color: 'var(--text-primary)', textDecoration: 'none', fontFamily: 'var(--font-body)' }}
              >
          ...
          {cs.pdfPath ? (
            <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', background: 'var(--bg-secondary)' }}>
              <div style={{ padding: '10px 16px', borderBottom: '1px solid var(--border)', fontSize: '12px', color: 'var(--text-muted)', fontFamily: 'var(--font-body)' }}>
                📄 {cs.pdfName || 'Document'}
              </div>
              <iframe
                src={cs.pdfPath}
